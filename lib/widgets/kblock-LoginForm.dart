  ...
  Widget build(BuildContext context) {
    ...
    return Form(
      ...
      child: Column(
        ...
        children: <Widget>[
          const Padding(padding: EdgeInsets.fromLTRB(0,91, 0, 72),
            child:Center(
              child: Text('K-BLOCK',
                  style: TextStyle(
          ...
          Padding(padding: const EdgeInsets.fromLTRB(34,0, 34, 0),
              child: SizedBox(
                height: 40.0,
                child: TextField(
          ...
          // password field
          Padding(padding: const EdgeInsets.fromLTRB(0, 10, 0, 6),
            child:Center(
          ...
          Padding(padding: const EdgeInsets.fromLTRB(0, 10, 0, 7),
            child:Center(
          ...
          Padding(padding: const EdgeInsets.fromLTRB(34, 30, 34, 7),
            child:Center(
              child: OutlinedButton(
                ...
                child: SizedBox(
                  ...
                  height: 40.0,
                  child: Padding(padding:  const EdgeInsets.fromLTRB(0, 10, 0, 12),
                      child:  SizedBox(
                          width: double.infinity,
                          child: Text(
